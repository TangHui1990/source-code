...
void Show(char temp[100]);   //显示客服端以及服务器目录
...
if(argc!=2)
{
printf("format error:you must enter ipaddr like this:client 192.168.0.6\n");
exit(0);
}
...
int login(char username[20],char userpaswd[10])
{
...
top:  printf("ID:");
      ...
      {
      printf("\n\033[33mUsername or passwd error!\033[0m\n\n");
      goto top;
      }
...
{
printf("\n\033[31mUpdata Files Over\033[0m\n");
}
...
case '1':
        {
        printf("\033[33mUpdata Files:\033[0m");
